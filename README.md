...
* Ввести в поле имя цифры или спецсимволы (например,%123).
* Ввести номер телефона из в формате +79005009999;
* Ввести email test@test.ru;
* Нажать кнопку записаться.
...
* Ввести имя на кириллице или латинице без спецсимволов и цифр;
* Ввести номер телефона из в формате +79005009999;
* Ввести email в формате test.test.ru или цифры 12345;
* Нажать кнопку записаться.
